---
name: competitor-analysis-th
description: breakdown คู่แข่ง SEO, content, positioning, pricing. Use when user wants to: วิเคราะห์คู่แข่ง. Triggers on (Thai+EN): 'วิเคราะห์คู่แข่ง', 'competitor analysis'
---
...
> **Skill ต้นฉบับ:** `competitor-analysis`
> **License:** MIT
...
ใช้ skill นี้เมื่อต้องการ **วิเคราะห์คู่แข่ง** — เหมาะกับ นักการตลาด, social media manager, freelancer

## วิธีใช้

บอก Claude ตรงๆ เช่น:

- "ช่วยวิเคราะห์คู่แข่งให้หน่อย"
- "ทำ competitor-analysis ให้"
- "วิเคราะห์คู่แข่ง"
...
```
วิเคราะห์คู่แข่ง — บริบทคือ [อธิบายสถานการณ์]
```

```
ช่วยวิเคราะห์คู่แข่งสำหรับ [target] — ต้องการแบบ [tone/style]
```
