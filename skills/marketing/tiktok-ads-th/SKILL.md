---
name: tiktok-ads-th
description: hook + creative brief สำหรับ TikTok Ads. Use when user wants to: TikTok Ads creative. Triggers on (Thai+EN): 'TikTok ads', 'โฆษณา tiktok'
---
...
ใช้ skill นี้เมื่อต้องการ **tiktok ads creative** — เหมาะกับ นักการตลาด, social media manager, freelancer

## วิธีใช้

บอก Claude ตรงๆ เช่น:

- "ช่วยtiktok ads creativeให้หน่อย"
- "ทำ tiktok-ads ให้"
- "TikTok ads"
...
```
TikTok ads — บริบทคือ [อธิบายสถานการณ์]
```

```
ช่วยtiktok ads creativeสำหรับ [target] — ต้องการแบบ [tone/style]
```
