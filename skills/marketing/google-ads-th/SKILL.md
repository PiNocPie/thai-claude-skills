---
name: google-ads-th
description: Google Ads copy ทั้ง headline + description. Use when user wants to: เขียน Google Ads. Triggers on (Thai+EN): 'Google ads', 'search ads'
---
...
ใช้ skill นี้เมื่อต้องการ **เขียน google ads** — เหมาะกับ นักการตลาด, social media manager, freelancer

## วิธีใช้

บอก Claude ตรงๆ เช่น:

- "ช่วยเขียน google adsให้หน่อย"
- "ทำ google-ads ให้"
- "Google ads"
...
```
Google ads — บริบทคือ [อธิบายสถานการณ์]
```

```
ช่วยเขียน google adsสำหรับ [target] — ต้องการแบบ [tone/style]
```
