---
name: ab-test-setup-th
description: hypothesis + variants + sample size. Use when user wants to: ออกแบบ A/B test. Triggers on (Thai+EN): 'A/B test', 'split test'
---
...
ใช้ skill นี้เมื่อต้องการ **ออกแบบ a/b test** — เหมาะกับ นักการตลาด, social media manager, freelancer

## วิธีใช้

บอก Claude ตรงๆ เช่น:

- "ช่วยออกแบบ a/b testให้หน่อย"
- "ทำ ab-test-setup ให้"
- "A/B test"
...
```
A/B test — บริบทคือ [อธิบายสถานการณ์]
```

```
ช่วยออกแบบ a/b testสำหรับ [target] — ต้องการแบบ [tone/style]
```
