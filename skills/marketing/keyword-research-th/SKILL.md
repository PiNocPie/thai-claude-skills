---
name: keyword-research-th
description: keyword research หา intent + volume + competition. Use when user wants to: หาคีย์เวิร์ดคอนเทนต์. Triggers on (Thai+EN): 'หา keyword', 'keyword research'
---

# หาคีย์เวิร์ดคอนเทนต์
...
> **Skill ต้นฉบับ:** `keyword-research`
> **License:** MIT
...
ใช้ skill นี้เมื่อต้องการ **หาคีย์เวิร์ดคอนเทนต์** — เหมาะกับ นักการตลาด, social media manager, freelancer

## วิธีใช้

บอก Claude ตรงๆ เช่น:

- "ช่วยหาคีย์เวิร์ดคอนเทนต์ให้หน่อย"
- "ทำ keyword-research ให้"
- "หา keyword"
...
```
หา keyword — บริบทคือ [อธิบายสถานการณ์]
```

```
ช่วยหาคีย์เวิร์ดคอนเทนต์สำหรับ [target] — ต้องการแบบ [tone/style]
```
