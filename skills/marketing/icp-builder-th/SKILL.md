---
name: icp-builder-th
description: กำหนด ICP + persona ละเอียด. Use when user wants to: สร้าง Ideal Customer Profile. Triggers on (Thai+EN): 'ICP', 'persona', 'ลูกค้าในอุดมคติ'
---
...
ใช้ skill นี้เมื่อต้องการ **สร้าง ideal customer profile** — เหมาะกับ นักการตลาด, social media manager, freelancer

## วิธีใช้

บอก Claude ตรงๆ เช่น:

- "ช่วยสร้าง ideal customer profileให้หน่อย"
- "ทำ icp-builder ให้"
- "ICP"
...
```
ICP — บริบทคือ [อธิบายสถานการณ์]
```

```
ช่วยสร้าง ideal customer profileสำหรับ [target] — ต้องการแบบ [tone/style]
```
