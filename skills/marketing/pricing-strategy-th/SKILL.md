---
name: pricing-strategy-th
description: pricing tier + page โน้มน้าวให้ซื้อ. Use when user wants to: กลยุทธ์ตั้งราคา. Triggers on (Thai+EN): 'pricing', 'ตั้งราคา'
---
...
> **Skill ต้นฉบับ:** `pricing-strategy`
> **License:** MIT
...
ใช้ skill นี้เมื่อต้องการ **กลยุทธ์ตั้งราคา** — เหมาะกับ นักการตลาด, social media manager, freelancer

## วิธีใช้

บอก Claude ตรงๆ เช่น:

- "ช่วยกลยุทธ์ตั้งราคาให้หน่อย"
- "ทำ pricing-strategy ให้"
- "pricing"
...
```
pricing — บริบทคือ [อธิบายสถานการณ์]
```

```
ช่วยกลยุทธ์ตั้งราคาสำหรับ [target] — ต้องการแบบ [tone/style]
```
