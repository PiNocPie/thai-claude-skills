---
name: marketing-psychology-th
description: 70+ principles ใช้ใน copy/ad/landing. Use when user wants to: จิตวิทยาในการตลาด. Triggers on (Thai+EN): 'จิตวิทยาตลาด', 'marketing psychology'
---
...
> **Skill ต้นฉบับ:** `marketing-psychology`
> **License:** MIT
...
ใช้ skill นี้เมื่อต้องการ **จิตวิทยาในการตลาด** — เหมาะกับ นักการตลาด, social media manager, freelancer

## วิธีใช้

บอก Claude ตรงๆ เช่น:

- "ช่วยจิตวิทยาในการตลาดให้หน่อย"
- "ทำ marketing-psychology ให้"
- "จิตวิทยาตลาด"
...
```
จิตวิทยาตลาด — บริบทคือ [อธิบายสถานการณ์]
```

```
ช่วยจิตวิทยาในการตลาดสำหรับ [target] — ต้องการแบบ [tone/style]
```
