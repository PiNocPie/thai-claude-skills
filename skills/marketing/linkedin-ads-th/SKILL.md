---
name: linkedin-ads-th
description: campaign สำหรับ B2B ผ่าน LinkedIn Ads. Use when user wants to: LinkedIn Ads B2B. Triggers on (Thai+EN): 'LinkedIn ads', 'B2B ads'
---
...
ใช้ skill นี้เมื่อต้องการ **linkedin ads b2b** — เหมาะกับ นักการตลาด, social media manager, freelancer

## วิธีใช้

บอก Claude ตรงๆ เช่น:

- "ช่วยlinkedin ads b2bให้หน่อย"
- "ทำ linkedin-ads ให้"
- "LinkedIn ads"
...
```
LinkedIn ads — บริบทคือ [อธิบายสถานการณ์]
```

```
ช่วยlinkedin ads b2bสำหรับ [target] — ต้องการแบบ [tone/style]
```
