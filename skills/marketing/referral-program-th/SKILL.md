---
name: referral-program-th
description: referral / viral loop. Use when user wants to: ออกแบบ referral program. Triggers on (Thai+EN): 'referral', 'แนะนำเพื่อน'
---

# ออกแบบ referral program
...
> **Skill ต้นฉบับ:** `referral-program`
> **License:** MIT
...
ใช้ skill นี้เมื่อต้องการ **ออกแบบ referral program** — เหมาะกับ นักการตลาด, social media manager, freelancer

## วิธีใช้

บอก Claude ตรงๆ เช่น:

- "ช่วยออกแบบ referral programให้หน่อย"
- "ทำ referral-program ให้"
- "referral"
...
```
referral — บริบทคือ [อธิบายสถานการณ์]
```

```
ช่วยออกแบบ referral programสำหรับ [target] — ต้องการแบบ [tone/style]
```
