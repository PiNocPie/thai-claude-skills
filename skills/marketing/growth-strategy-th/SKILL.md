---
name: growth-strategy-th
description: growth experiment + growth loop. Use when user wants to: AARRR growth framework. Triggers on (Thai+EN): 'growth', 'AARRR'
---
...
ใช้ skill นี้เมื่อต้องการ **aarrr growth framework** — เหมาะกับ นักการตลาด, social media manager, freelancer

## วิธีใช้

บอก Claude ตรงๆ เช่น:

- "ช่วยaarrr growth frameworkให้หน่อย"
- "ทำ growth-strategy ให้"
- "growth"
...
```
growth — บริบทคือ [อธิบายสถานการณ์]
```

```
ช่วยaarrr growth frameworkสำหรับ [target] — ต้องการแบบ [tone/style]
```
