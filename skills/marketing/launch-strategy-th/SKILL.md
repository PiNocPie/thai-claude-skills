---
name: launch-strategy-th
description: pre-launch, launch day, post-launch. Use when user wants to: แผน launch สินค้า. Triggers on (Thai+EN): 'launch strategy', 'แผน launch'
---
...
ใช้ skill นี้เมื่อต้องการ **แผน launch สินค้า** — เหมาะกับ นักการตลาด, social media manager, freelancer

## วิธีใช้

บอก Claude ตรงๆ เช่น:

- "ช่วยแผน launch สินค้าให้หน่อย"
- "ทำ launch-strategy ให้"
- "launch strategy"
...
```
launch strategy — บริบทคือ [อธิบายสถานการณ์]
```

```
ช่วยแผน launch สินค้าสำหรับ [target] — ต้องการแบบ [tone/style]
```
