...
description: email subject lines + A/B test variants. Use when user wants to: หัวข้ออีเมลคนเปิด. Triggers on (Thai+EN): 'subject line', 'หัวข้ออีเมล'
---
...
> **Skill ต้นฉบับ:** `email-subject-lines`
> **License:** MIT
...
ใช้ skill นี้เมื่อต้องการ **หัวข้ออีเมลคนเปิด** — เหมาะกับ นักการตลาด, social media manager, freelancer

## วิธีใช้

บอก Claude ตรงๆ เช่น:

- "ช่วยหัวข้ออีเมลคนเปิดให้หน่อย"
- "ทำ email-subject-lines ให้"
- "subject line"
...
```
subject line — บริบทคือ [อธิบายสถานการณ์]
```

```
ช่วยหัวข้ออีเมลคนเปิดสำหรับ [target] — ต้องการแบบ [tone/style]
```
