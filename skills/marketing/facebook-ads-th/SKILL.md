---
name: facebook-ads-th
description: สร้าง ad copy + creative brief สำหรับ Meta Ads. Use when user wants to: เขียน Facebook Ads. Triggers on (Thai+EN): 'FB ads', 'Facebook ads', 'โฆษณาเฟส'
---
...
ใช้ skill นี้เมื่อต้องการ **เขียน facebook ads** — เหมาะกับ นักการตลาด, social media manager, freelancer

## วิธีใช้

บอก Claude ตรงๆ เช่น:

- "ช่วยเขียน facebook adsให้หน่อย"
- "ทำ facebook-ads ให้"
- "FB ads"
...
```
FB ads — บริบทคือ [อธิบายสถานการณ์]
```

```
ช่วยเขียน facebook adsสำหรับ [target] — ต้องการแบบ [tone/style]
```
