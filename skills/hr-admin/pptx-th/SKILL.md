---
name: pptx-th
description: สร้าง .pptx slide deck | สำหรับ HR ธุรการ หรือผู้จัดการที่ต้อง. Triggers when user says (Thai/EN): 'powerpoint', 'ppt', 'สไลด์'
---

# สร้าง PowerPoint slide

> 🇹🇭 ดัดแปลงเป็นภาษาไทยจาก [anthropics/skills](https://github.com/anthropics/skills/tree/main/skills/pptx) · License: Apache-2.0

## ทำอะไรได้

สร้าง .pptx slide deck
...
```
"ช่วยสร้าง PowerPoint slide ให้หน่อย บริบทคือ [อธิบายสถานการณ์ของคุณ]"
```

```
"สไลด์ สำหรับ [กลุ่มเป้าหมาย], อยากได้แบบ [น้ำเสียง/สไตล์]"
```
