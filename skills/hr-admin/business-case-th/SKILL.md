---
name: business-case-th
description: business case โน้มน้าวให้อนุมัติ | สำหรับ HR ธุรการ หรือผู้จัดการที่ต้อง. Triggers when user says (Thai/EN): 'business case'
---

# เขียน Business Case

> 🇹🇭 ดัดแปลงเป็นภาษาไทยจาก [w95/awesome-claude-corporate-skills](https://github.com/w95/awesome-claude-corporate-skills/tree/main/07-operations/business-case-builder) · License: MIT

## ทำอะไรได้

business case โน้มน้าวให้อนุมัติ
...
```
"ช่วยเขียน Business Case ให้หน่อย บริบทคือ [อธิบายสถานการณ์ของคุณ]"
```

```
"business case สำหรับ [กลุ่มเป้าหมาย], อยากได้แบบ [น้ำเสียง/สไตล์]"
```
