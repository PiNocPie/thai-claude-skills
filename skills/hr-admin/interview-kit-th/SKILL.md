---
name: interview-kit-th
description: interview kit ตามตำแหน่ง + rubric | สำหรับ HR ธุรการ หรือผู้จัดการที่ต้อง. Triggers when user says (Thai/EN): 'interview kit', 'คำถามสัมภาษณ์'
---

# ชุดคำถามสัมภาษณ์

> 🇹🇭 ดัดแปลงเป็นภาษาไทยจาก [w95/awesome-claude-corporate-skills](https://github.com/w95/awesome-claude-corporate-skills/tree/main/03-human-resources/interview-kit) · License: MIT

## ทำอะไรได้

interview kit ตามตำแหน่ง + rubric
...
```
"ช่วยชุดคำถามสัมภาษณ์ ให้หน่อย บริบทคือ [อธิบายสถานการณ์ของคุณ]"
```

```
"คำถามสัมภาษณ์ สำหรับ [กลุ่มเป้าหมาย], อยากได้แบบ [น้ำเสียง/สไตล์]"
```
