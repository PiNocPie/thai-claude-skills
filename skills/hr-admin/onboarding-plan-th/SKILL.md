---
name: onboarding-plan-th
description: onboarding plan พนักงานใหม่ | สำหรับ HR ธุรการ หรือผู้จัดการที่ต้อง. Triggers when user says (Thai/EN): 'onboarding', 'พนักงานใหม่'
---

# แผน onboarding 30-60-90 วัน

> 🇹🇭 ดัดแปลงเป็นภาษาไทยจาก [w95/awesome-claude-corporate-skills](https://github.com/w95/awesome-claude-corporate-skills/tree/main/03-human-resources/onboarding) · License: MIT

## ทำอะไรได้

onboarding plan พนักงานใหม่
...
```
"ช่วยแผน onboarding 30-60-90 วัน ให้หน่อย บริบทคือ [อธิบายสถานการณ์ของคุณ]"
```

```
"พนักงานใหม่ สำหรับ [กลุ่มเป้าหมาย], อยากได้แบบ [น้ำเสียง/สไตล์]"
```
