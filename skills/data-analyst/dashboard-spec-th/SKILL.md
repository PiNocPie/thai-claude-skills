---
name: dashboard-spec-th
description: requirements + metric + layout. Use when user wants to: spec dashboard. Triggers on (Thai+EN): 'dashboard spec'
---
...
> **Skill ต้นฉบับ:** `04-data-storytelling-visualization/dashboard-specification`
...
ใช้ skill นี้เมื่อต้องการ **spec dashboard** — เหมาะกับ data analyst, BI, marketing analyst

## วิธีใช้

บอก Claude ตรงๆ เช่น:

- "ช่วยspec dashboardให้หน่อย"
- "ทำ 04-data-storytelling-visualization/dashboard-specification ให้"
- "dashboard spec"
...
```
dashboard spec — บริบทคือ [อธิบายสถานการณ์]
```

```
ช่วยspec dashboardสำหรับ [target] — ต้องการแบบ [tone/style]
```
