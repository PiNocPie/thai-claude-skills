---
name: root-cause-th
description: structured root cause investigation. Use when user wants to: หาสาเหตุ metric ตก/พุ่ง. Triggers on (Thai+EN): 'root cause', 'metric ตก'
---

# หาสาเหตุ metric ตก/พุ่ง
...
> **Skill ต้นฉบับ:** `03-data-analysis-investigation/root-cause-investigation`
...
ใช้ skill นี้เมื่อต้องการ **หาสาเหตุ metric ตก/พุ่ง** — เหมาะกับ data analyst, BI, marketing analyst

## วิธีใช้

บอก Claude ตรงๆ เช่น:

- "ช่วยหาสาเหตุ metric ตก/พุ่งให้หน่อย"
- "ทำ 03-data-analysis-investigation/root-cause-investigation ให้"
- "root cause"
...
```
root cause — บริบทคือ [อธิบายสถานการณ์]
```

```
ช่วยหาสาเหตุ metric ตก/พุ่งสำหรับ [target] — ต้องการแบบ [tone/style]
```
