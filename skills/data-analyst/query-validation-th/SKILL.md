---
name: query-validation-th
description: SQL review correctness + performance. Use when user wants to: ตรวจ SQL query. Triggers on (Thai+EN): 'sql review', 'ตรวจ sql'
---
...
> **Skill ต้นฉบับ:** `01-data-quality-validation/query-validation`
...
ใช้ skill นี้เมื่อต้องการ **ตรวจ sql query** — เหมาะกับ data analyst, BI, marketing analyst

## วิธีใช้

บอก Claude ตรงๆ เช่น:

- "ช่วยตรวจ sql queryให้หน่อย"
- "ทำ 01-data-quality-validation/query-validation ให้"
- "sql review"
...
```
sql review — บริบทคือ [อธิบายสถานการณ์]
```

```
ช่วยตรวจ sql queryสำหรับ [target] — ต้องการแบบ [tone/style]
```
