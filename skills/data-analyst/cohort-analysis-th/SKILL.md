---
name: cohort-analysis-th
description: cohort retention curve + insight. Use when user wants to: Cohort analysis. Triggers on (Thai+EN): 'cohort analysis'
---
...
> **Skill ต้นฉบับ:** `03-data-analysis-investigation/cohort-analysis`
...
ใช้ skill นี้เมื่อต้องการ **cohort analysis** — เหมาะกับ data analyst, BI, marketing analyst

## วิธีใช้

บอก Claude ตรงๆ เช่น:

- "ช่วยcohort analysisให้หน่อย"
- "ทำ 03-data-analysis-investigation/cohort-analysis ให้"
- "cohort analysis"
...
```
cohort analysis — บริบทคือ [อธิบายสถานการณ์]
```

```
ช่วยcohort analysisสำหรับ [target] — ต้องการแบบ [tone/style]
```
