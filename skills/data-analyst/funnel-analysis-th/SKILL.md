---
name: funnel-analysis-th
description: conversion funnel + root cause drop-off. Use when user wants to: Funnel + drop-off analysis. Triggers on (Thai+EN): 'funnel', 'drop off'
---
...
> **Skill ต้นฉบับ:** `03-data-analysis-investigation/funnel-analysis`
...
ใช้ skill นี้เมื่อต้องการ **funnel + drop-off analysis** — เหมาะกับ data analyst, BI, marketing analyst

## วิธีใช้

บอก Claude ตรงๆ เช่น:

- "ช่วยfunnel + drop-off analysisให้หน่อย"
- "ทำ 03-data-analysis-investigation/funnel-analysis ให้"
- "funnel"
...
```
funnel — บริบทคือ [อธิบายสถานการณ์]
```

```
ช่วยfunnel + drop-off analysisสำหรับ [target] — ต้องการแบบ [tone/style]
```
