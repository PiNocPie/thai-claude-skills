---
name: data-quality-audit-th
description: audit ข้อมูลตาม business rules + schema. Use when user wants to: ตรวจคุณภาพข้อมูล. Triggers on (Thai+EN): 'data quality', 'ตรวจข้อมูล'
---
...
> **Skill ต้นฉบับ:** `01-data-quality-validation/data-quality-audit`
...
ใช้ skill นี้เมื่อต้องการ **ตรวจคุณภาพข้อมูล** — เหมาะกับ data analyst, BI, marketing analyst

## วิธีใช้

บอก Claude ตรงๆ เช่น:

- "ช่วยตรวจคุณภาพข้อมูลให้หน่อย"
- "ทำ 01-data-quality-validation/data-quality-audit ให้"
- "data quality"
...
```
data quality — บริบทคือ [อธิบายสถานการณ์]
```

```
ช่วยตรวจคุณภาพข้อมูลสำหรับ [target] — ต้องการแบบ [tone/style]
```
