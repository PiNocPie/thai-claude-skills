---
name: excel-pivot-th
description: สร้าง pivot table + chart อัตโนมัติ. Use when user wants to: Excel Pivot Wizard. Triggers on (Thai+EN): 'pivot table', 'pivot excel'
---

# Excel Pivot Wizard

> 🇹🇭 **ปรับมาเป็นภาษาไทย** | Adapted to Thai
> **ดัดแปลงจาก:** [jeremylongshore/excel-analyst-pro](https://github.com/jeremylongshore/excel-analyst-pro)
> **Skill ต้นฉบับ:** `excel-pivot-wizard`
> **License:** MIT
...
ใช้ skill นี้เมื่อต้องการ **excel pivot wizard** — เหมาะกับ data analyst, BI, marketing analyst

## วิธีใช้

บอก Claude ตรงๆ เช่น:

- "ช่วยexcel pivot wizardให้หน่อย"
- "ทำ excel-pivot-wizard ให้"
- "pivot table"
...
```
pivot table — บริบทคือ [อธิบายสถานการณ์]
```

```
ช่วยexcel pivot wizardสำหรับ [target] — ต้องการแบบ [tone/style]
```
...
Skill นี้ดัดแปลงจาก [jeremylongshore/excel-analyst-pro](https://github.com/jeremylongshore/excel-analyst-pro) ภายใต้ MIT License
