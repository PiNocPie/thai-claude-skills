...
description: รายงาน structured ตามมาตรฐาน. Use when user wants to: เขียนรายงานวิชา. Triggers on (Thai+EN): 'รายงาน', 'report'
---
...
ใช้ skill นี้เมื่อต้องการ **เขียนรายงานวิชา** — เหมาะกับ นักศึกษา ป.ตรี/โท ที่ต้องส่งรายงาน/เลคเชอร์/สอบ

## วิธีใช้

บอก Claude ตรงๆ เช่น:

- "ช่วยเขียนรายงานวิชาให้หน่อย"
- "ทำ academic-report ให้"
- "รายงาน"
...
```
รายงาน — บริบทคือ [อธิบายสถานการณ์]
```

```
ช่วยเขียนรายงานวิชาสำหรับ [target] — ต้องการแบบ [tone/style]
```
