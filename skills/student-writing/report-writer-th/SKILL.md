---
name: report-writer-th
description: รายงาน structured ตามมาตรฐาน | สำหรับ นักศึกษา. Triggers when user says (Thai/EN): 'รายงาน', 'report'
---

# เขียนรายงานวิชา

> 🇹🇭 ดัดแปลงเป็นภาษาไทยจาก [VoltAgent/awesome-agent-skills](https://github.com/VoltAgent/awesome-agent-skills/tree/main/skills/academic-report) · License: MIT

## ทำอะไรได้

รายงาน structured ตามมาตรฐาน
...
```
"ช่วยเขียนรายงานวิชา ให้หน่อย บริบทคือ [อธิบายสถานการณ์ของคุณ]"
```

```
"รายงาน สำหรับ [กลุ่มเป้าหมาย], อยากได้แบบ [น้ำเสียง/สไตล์]"
```
