---
name: flashcard-th
description: flashcard format Q&A พร้อม Anki export. Use when user wants to: สร้าง flashcard ท่องสอบ. Triggers on (Thai+EN): 'flashcard', 'ท่องสอบ'
---

# สร้าง flashcard ท่องสอบ
...
> **Skill ต้นฉบับ:** `flashcard-generator`
> **License:** MIT
...
ใช้ skill นี้เมื่อต้องการ **สร้าง flashcard ท่องสอบ** — เหมาะกับ นักศึกษา ป.ตรี/โท ที่ต้องส่งรายงาน/เลคเชอร์/สอบ

## วิธีใช้

บอก Claude ตรงๆ เช่น:

- "ช่วยสร้าง flashcard ท่องสอบให้หน่อย"
- "ทำ flashcard-generator ให้"
- "flashcard"
...
```
flashcard — บริบทคือ [อธิบายสถานการณ์]
```

```
ช่วยสร้าง flashcard ท่องสอบสำหรับ [target] — ต้องการแบบ [tone/style]
```
