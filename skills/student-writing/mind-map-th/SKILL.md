---
name: mind-map-th
description: mind map สรุปวิชา. Use when user wants to: สร้าง mind map. Triggers on (Thai+EN): 'mind map'
---
...
ใช้ skill นี้เมื่อต้องการ **สร้าง mind map** — เหมาะกับ นักศึกษา ป.ตรี/โท ที่ต้องส่งรายงาน/เลคเชอร์/สอบ

## วิธีใช้

บอก Claude ตรงๆ เช่น:

- "ช่วยสร้าง mind mapให้หน่อย"
- "ทำ mind-map ให้"
- "mind map"
...
```
mind map — บริบทคือ [อธิบายสถานการณ์]
```

```
ช่วยสร้าง mind mapสำหรับ [target] — ต้องการแบบ [tone/style]
```
