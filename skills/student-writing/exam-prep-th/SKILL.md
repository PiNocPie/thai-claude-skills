---
name: exam-prep-th
description: study plan + practice question | สำหรับ นักศึกษา. Triggers when user says (Thai/EN): 'เตรียมสอบ', 'exam prep'
---

# แผนเตรียมสอบ

> 🇹🇭 ดัดแปลงเป็นภาษาไทยจาก [VoltAgent/awesome-agent-skills](https://github.com/VoltAgent/awesome-agent-skills/tree/main/skills/exam-prep) · License: MIT

## ทำอะไรได้

study plan + practice question
...
```
"ช่วยแผนเตรียมสอบ ให้หน่อย บริบทคือ [อธิบายสถานการณ์ของคุณ]"
```

```
"เตรียมสอบ สำหรับ [กลุ่มเป้าหมาย], อยากได้แบบ [น้ำเสียง/สไตล์]"
```
