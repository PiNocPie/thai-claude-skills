---
name: exam-prep-th
description: study plan + practice question. Use when user wants to: แผนเตรียมสอบ. Triggers on (Thai+EN): 'เตรียมสอบ', 'exam prep'
---
...
ใช้ skill นี้เมื่อต้องการ **แผนเตรียมสอบ** — เหมาะกับ นักศึกษา ป.ตรี/โท ที่ต้องส่งรายงาน/เลคเชอร์/สอบ

## วิธีใช้

บอก Claude ตรงๆ เช่น:

- "ช่วยแผนเตรียมสอบให้หน่อย"
- "ทำ exam-prep ให้"
- "เตรียมสอบ"
...
```
เตรียมสอบ — บริบทคือ [อธิบายสถานการณ์]
```

```
ช่วยแผนเตรียมสอบสำหรับ [target] — ต้องการแบบ [tone/style]
```
