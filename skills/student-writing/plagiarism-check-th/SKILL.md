...
description: paraphrase + ลดการลอก. Use when user wants to: ตรวจ paraphrase + plagiarism. Triggers on (Thai+EN): 'plagiarism', 'paraphrase'
---
...
> **Skill ต้นฉบับ:** `paraphrase-helper`
> **License:** MIT
...
ใช้ skill นี้เมื่อต้องการ **ตรวจ paraphrase + plagiarism** — เหมาะกับ นักศึกษา ป.ตรี/โท ที่ต้องส่งรายงาน/เลคเชอร์/สอบ

## วิธีใช้

บอก Claude ตรงๆ เช่น:

- "ช่วยตรวจ paraphrase + plagiarismให้หน่อย"
- "ทำ paraphrase-helper ให้"
- "plagiarism"
...
```
plagiarism — บริบทคือ [อธิบายสถานการณ์]
```

```
ช่วยตรวจ paraphrase + plagiarismสำหรับ [target] — ต้องการแบบ [tone/style]
```
