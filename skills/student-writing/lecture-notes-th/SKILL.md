...
description: จดเลคเชอร์ Cornell method. Use when user wants to: สรุปเลคเชอร์. Triggers on (Thai+EN): 'lecture notes', 'สรุปเลคเชอร์'
---
...
ใช้ skill นี้เมื่อต้องการ **สรุปเลคเชอร์** — เหมาะกับ นักศึกษา ป.ตรี/โท ที่ต้องส่งรายงาน/เลคเชอร์/สอบ

## วิธีใช้

บอก Claude ตรงๆ เช่น:

- "ช่วยสรุปเลคเชอร์ให้หน่อย"
- "ทำ lecture-notes ให้"
- "lecture notes"
...
```
lecture notes — บริบทคือ [อธิบายสถานการณ์]
```

```
ช่วยสรุปเลคเชอร์สำหรับ [target] — ต้องการแบบ [tone/style]
```
