---
name: presentation-student-th
description: สคริปต์ + slide สำหรับ presentation วิชา. Use when user wants to: นำเสนองานกลุ่ม. Triggers on (Thai+EN): 'presentation นักศึกษา', 'นำเสนองาน'
---
...
> **Skill ต้นฉบับ:** `student-presentation`
> **License:** MIT
...
ใช้ skill นี้เมื่อต้องการ **นำเสนองานกลุ่ม** — เหมาะกับ นักศึกษา ป.ตรี/โท ที่ต้องส่งรายงาน/เลคเชอร์/สอบ

## วิธีใช้

บอก Claude ตรงๆ เช่น:

- "ช่วยนำเสนองานกลุ่มให้หน่อย"
- "ทำ student-presentation ให้"
- "presentation นักศึกษา"
...
```
presentation นักศึกษา — บริบทคือ [อธิบายสถานการณ์]
```

```
ช่วยนำเสนองานกลุ่มสำหรับ [target] — ต้องการแบบ [tone/style]
```
