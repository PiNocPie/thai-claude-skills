---
name: essay-writer-th
description: essay 5 paragraph + argument | สำหรับ นักศึกษา. Triggers when user says (Thai/EN): 'essay', 'เรียงความ'
---

# เขียน essay

> 🇹🇭 ดัดแปลงเป็นภาษาไทยจาก [VoltAgent/awesome-agent-skills](https://github.com/VoltAgent/awesome-agent-skills/tree/main/skills/essay-writer) · License: MIT

## ทำอะไรได้

essay 5 paragraph + argument
...
```
"ช่วยเขียน essay ให้หน่อย บริบทคือ [อธิบายสถานการณ์ของคุณ]"
```

```
"เรียงความ สำหรับ [กลุ่มเป้าหมาย], อยากได้แบบ [น้ำเสียง/สไตล์]"
```
