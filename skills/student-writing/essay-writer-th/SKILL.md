...
description: essay 5 paragraph + argument. Use when user wants to: เขียน essay. Triggers on (Thai+EN): 'essay', 'เรียงความ'
---
...
ใช้ skill นี้เมื่อต้องการ **เขียน essay** — เหมาะกับ นักศึกษา ป.ตรี/โท ที่ต้องส่งรายงาน/เลคเชอร์/สอบ

## วิธีใช้

บอก Claude ตรงๆ เช่น:

- "ช่วยเขียน essayให้หน่อย"
- "ทำ essay-writer ให้"
- "essay"
...
```
essay — บริบทคือ [อธิบายสถานการณ์]
```

```
ช่วยเขียน essayสำหรับ [target] — ต้องการแบบ [tone/style]
```
