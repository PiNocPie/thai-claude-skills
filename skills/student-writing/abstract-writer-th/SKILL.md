...
description: abstract วิจัย 200-300 คำ. Use when user wants to: เขียน abstract. Triggers on (Thai+EN): 'abstract'
---
...
ใช้ skill นี้เมื่อต้องการ **เขียน abstract** — เหมาะกับ นักศึกษา ป.ตรี/โท ที่ต้องส่งรายงาน/เลคเชอร์/สอบ

## วิธีใช้

บอก Claude ตรงๆ เช่น:

- "ช่วยเขียน abstractให้หน่อย"
- "ทำ abstract-writer ให้"
- "abstract"
...
```
abstract — บริบทคือ [อธิบายสถานการณ์]
```

```
ช่วยเขียน abstractสำหรับ [target] — ต้องการแบบ [tone/style]
```
