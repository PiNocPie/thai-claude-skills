---
name: book-review-th
description: review หนังสือ academic. Use when user wants to: เขียน book review. Triggers on (Thai+EN): 'book review', 'รีวิวหนังสือ'
---
...
ใช้ skill นี้เมื่อต้องการ **เขียน book review** — เหมาะกับ นักศึกษา ป.ตรี/โท ที่ต้องส่งรายงาน/เลคเชอร์/สอบ

## วิธีใช้

บอก Claude ตรงๆ เช่น:

- "ช่วยเขียน book reviewให้หน่อย"
- "ทำ book-review ให้"
- "book review"
...
```
book review — บริบทคือ [อธิบายสถานการณ์]
```

```
ช่วยเขียน book reviewสำหรับ [target] — ต้องการแบบ [tone/style]
```
