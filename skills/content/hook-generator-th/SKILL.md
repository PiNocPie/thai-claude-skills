...
description: hooks 10 รูปแบบให้เลือกใช้. Use when user wants to: สร้าง hook 3 วิแรก. Triggers on (Thai+EN): 'hook', 'ปัง 3 วิ'
---
...
ใช้ skill นี้เมื่อต้องการ **สร้าง hook 3 วิแรก** — เหมาะกับ นักเขียน, content creator, นักศึกษาที่ทำ personal brand

## วิธีใช้

บอก Claude ตรงๆ เช่น:

- "ช่วยสร้าง hook 3 วิแรกให้หน่อย"
- "ทำ hook-writer ให้"
- "hook"
...
```
hook — บริบทคือ [อธิบายสถานการณ์]
```

```
ช่วยสร้าง hook 3 วิแรกสำหรับ [target] — ต้องการแบบ [tone/style]
```
