...
"[0:v]scale=1080:1920:flags=bicubic,zoompan=z='min(1.0+on/1600,1.09)':d=1:x='iw/2-(iw/zoom/2)':y='ih/2-(ih/zoom/2)':s=1080x1920:fps=30,setsar=1[base];[base][1:v]overlay=0:0[v]" \
