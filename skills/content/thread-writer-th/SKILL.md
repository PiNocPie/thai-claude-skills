...
description: viral thread บน X + Reddit. Use when user wants to: เขียน thread X/Twitter. Triggers on (Thai+EN): 'thread', 'X thread'
---
...
ใช้ skill นี้เมื่อต้องการ **เขียน thread x/twitter** — เหมาะกับ นักเขียน, content creator, นักศึกษาที่ทำ personal brand

## วิธีใช้

บอก Claude ตรงๆ เช่น:

- "ช่วยเขียน thread x/twitterให้หน่อย"
- "ทำ thread-writer ให้"
- "thread"
...
```
thread — บริบทคือ [อธิบายสถานการณ์]
```

```
ช่วยเขียน thread x/twitterสำหรับ [target] — ต้องการแบบ [tone/style]
```
