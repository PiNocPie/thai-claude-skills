---
name: thread-writer-th
description: viral thread บน X + Reddit | สำหรับ นักเขียน คอนเทนต์ครีเอเตอร์ หร. Triggers when user says (Thai/EN): 'thread', 'X thread'
---

# เขียน thread X/Twitter

> 🇹🇭 ดัดแปลงเป็นภาษาไทยจาก [OpenClaudia/openclaudia-skills](https://github.com/OpenClaudia/openclaudia-skills/tree/main/skills/thread-writer) · License: MIT

## ทำอะไรได้

viral thread บน X + Reddit
...
```
"ช่วยเขียน thread X/Twitter ให้หน่อย บริบทคือ [อธิบายสถานการณ์ของคุณ]"
```

```
"thread สำหรับ [กลุ่มเป้าหมาย], อยากได้แบบ [น้ำเสียง/สไตล์]"
```
