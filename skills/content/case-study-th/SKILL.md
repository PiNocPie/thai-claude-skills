---
name: case-study-th
description: format Challenge-Solution-Results. Use when user wants to: เขียน customer case study. Triggers on (Thai+EN): 'case study', 'success story'
---

# เขียน customer case study

> 🇹🇭 **ปรับมาเป็นภาษาไทย** | Adapted to Thai
> **ดัดแปลงจาก:** [w95/awesome-claude-corporate-skills](https://github.com/w95/awesome-claude-corporate-skills)
> **Skill ต้นฉบับ:** `04-marketing/case-study`
> **License:** MIT
...
ใช้ skill นี้เมื่อต้องการ **เขียน customer case study** — เหมาะกับ นักเขียน, content creator, นักศึกษาที่ทำ personal brand

## วิธีใช้

บอก Claude ตรงๆ เช่น:

- "ช่วยเขียน customer case studyให้หน่อย"
- "ทำ 04-marketing/case-study ให้"
- "case study"
...
```
case study — บริบทคือ [อธิบายสถานการณ์]
```

```
ช่วยเขียน customer case studyสำหรับ [target] — ต้องการแบบ [tone/style]
```
...
Skill นี้ดัดแปลงจาก [w95/awesome-claude-corporate-skills](https://github.com/w95/awesome-claude-corporate-skills) ภายใต้ MIT License
