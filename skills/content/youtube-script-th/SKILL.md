...
description: YT script 8-15 นาที + retention hooks. Use when user wants to: สคริปต์ YouTube. Triggers on (Thai+EN): 'youtube script'
---
...
ใช้ skill นี้เมื่อต้องการ **สคริปต์ youtube** — เหมาะกับ นักเขียน, content creator, นักศึกษาที่ทำ personal brand

## วิธีใช้

บอก Claude ตรงๆ เช่น:

- "ช่วยสคริปต์ youtubeให้หน่อย"
- "ทำ youtube-script ให้"
- "youtube script"
...
```
youtube script — บริบทคือ [อธิบายสถานการณ์]
```

```
ช่วยสคริปต์ youtubeสำหรับ [target] — ต้องการแบบ [tone/style]
```
