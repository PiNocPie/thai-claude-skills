---
name: press-release-th
description: PR ตามมาตรฐาน inverted pyramid. Use when user wants to: เขียน press release. Triggers on (Thai+EN): 'press release', 'ข่าวประชาสัมพันธ์'
---
...
> **Skill ต้นฉบับ:** `04-marketing/press-release`
> **License:** MIT
...
ใช้ skill นี้เมื่อต้องการ **เขียน press release** — เหมาะกับ นักเขียน, content creator, นักศึกษาที่ทำ personal brand

## วิธีใช้

บอก Claude ตรงๆ เช่น:

- "ช่วยเขียน press releaseให้หน่อย"
- "ทำ 04-marketing/press-release ให้"
- "press release"
...
```
press release — บริบทคือ [อธิบายสถานการณ์]
```

```
ช่วยเขียน press releaseสำหรับ [target] — ต้องการแบบ [tone/style]
```
