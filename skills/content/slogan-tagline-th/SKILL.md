---
name: slogan-tagline-th
description: generate tagline 20 ตัว + เหตุผล. Use when user wants to: สร้าง slogan / tagline. Triggers on (Thai+EN): 'slogan', 'tagline', 'สโลแกน'
---

# สร้าง slogan / tagline
...
ใช้ skill นี้เมื่อต้องการ **สร้าง slogan / tagline** — เหมาะกับ นักเขียน, content creator, นักศึกษาที่ทำ personal brand

## วิธีใช้

บอก Claude ตรงๆ เช่น:

- "ช่วยสร้าง slogan / taglineให้หน่อย"
- "ทำ tagline-writer ให้"
- "slogan"
...
```
slogan — บริบทคือ [อธิบายสถานการณ์]
```

```
ช่วยสร้าง slogan / taglineสำหรับ [target] — ต้องการแบบ [tone/style]
```
