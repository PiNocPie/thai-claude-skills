---
name: write-landing-th
description: copy หน้า landing เปลี่ยน visitor เป็น lead | สำหรับ นักเขียน คอนเทนต์ครีเอเตอร์ หร. Triggers when user says (Thai/EN): 'landing page', 'หน้า landing'
---

# เขียน landing page copy

> 🇹🇭 ดัดแปลงเป็นภาษาไทยจาก [OpenClaudia/openclaudia-skills](https://github.com/OpenClaudia/openclaudia-skills/tree/main/skills/write-landing) · License: MIT

## ทำอะไรได้

copy หน้า landing เปลี่ยน visitor เป็น lead
...
```
"ช่วยเขียน landing page copy ให้หน่อย บริบทคือ [อธิบายสถานการณ์ของคุณ]"
```

```
"หน้า landing สำหรับ [กลุ่มเป้าหมาย], อยากได้แบบ [น้ำเสียง/สไตล์]"
```
