...
description: copy หน้า landing เปลี่ยน visitor เป็น lead. Use when user wants to: เขียน landing page copy. Triggers on (Thai+EN): 'landing page', 'หน้า landing'
---
...
ใช้ skill นี้เมื่อต้องการ **เขียน landing page copy** — เหมาะกับ นักเขียน, content creator, นักศึกษาที่ทำ personal brand

## วิธีใช้

บอก Claude ตรงๆ เช่น:

- "ช่วยเขียน landing page copyให้หน่อย"
- "ทำ write-landing ให้"
- "landing page"
...
```
landing page — บริบทคือ [อธิบายสถานการณ์]
```

```
ช่วยเขียน landing page copyสำหรับ [target] — ต้องการแบบ [tone/style]
```
