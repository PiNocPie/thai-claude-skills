---
name: ux-writing-th
description: button/error/empty state copy. Use when user wants to: UX writing — microcopy. Triggers on (Thai+EN): 'UX writing', 'microcopy'
---

# UX writing — microcopy

> 🇹🇭 **ปรับมาเป็นภาษาไทย** | Adapted to Thai
> **ดัดแปลงจาก:** [content-designer/ux-writing-skill](https://github.com/content-designer/ux-writing-skill)
> **Skill ต้นฉบับ:** `ux-writing`
> **License:** MIT
...
ใช้ skill นี้เมื่อต้องการ **ux writing — microcopy** — เหมาะกับ นักเขียน, content creator, นักศึกษาที่ทำ personal brand

## วิธีใช้

บอก Claude ตรงๆ เช่น:

- "ช่วยux writing — microcopyให้หน่อย"
- "ทำ ux-writing ให้"
- "UX writing"
...
```
UX writing — บริบทคือ [อธิบายสถานการณ์]
```

```
ช่วยux writing — microcopyสำหรับ [target] — ต้องการแบบ [tone/style]
```
...
Skill นี้ดัดแปลงจาก [content-designer/ux-writing-skill](https://github.com/content-designer/ux-writing-skill) ภายใต้ MIT License
