...
description: line-by-line edit + ปรับ tone. Use when user wants to: ขัดเกลา copy ทีละบรรทัด. Triggers on (Thai+EN): 'copy edit', 'ขัดเกลา copy'
---
...
ใช้ skill นี้เมื่อต้องการ **ขัดเกลา copy ทีละบรรทัด** — เหมาะกับ นักเขียน, content creator, นักศึกษาที่ทำ personal brand

## วิธีใช้

บอก Claude ตรงๆ เช่น:

- "ช่วยขัดเกลา copy ทีละบรรทัดให้หน่อย"
- "ทำ copy-editing ให้"
- "copy edit"
...
```
copy edit — บริบทคือ [อธิบายสถานการณ์]
```

```
ช่วยขัดเกลา copy ทีละบรรทัดสำหรับ [target] — ต้องการแบบ [tone/style]
```
