---
name: copywriting-th
description: copy การตลาดสำหรับทุก page type. Use when user wants to: Marketing copywriting. Triggers on (Thai+EN): 'copywriting', 'เขียน copy'
---
...
ใช้ skill นี้เมื่อต้องการ **marketing copywriting** — เหมาะกับ นักเขียน, content creator, นักศึกษาที่ทำ personal brand

## วิธีใช้

บอก Claude ตรงๆ เช่น:

- "ช่วยmarketing copywritingให้หน่อย"
- "ทำ copywriting ให้"
- "copywriting"
...
```
copywriting — บริบทคือ [อธิบายสถานการณ์]
```

```
ช่วยmarketing copywritingสำหรับ [target] — ต้องการแบบ [tone/style]
```
