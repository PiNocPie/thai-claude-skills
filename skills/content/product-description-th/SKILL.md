---
name: product-description-th
description: feature-benefit สำหรับ ecom. Use when user wants to: เขียน product description. Triggers on (Thai+EN): 'product description', 'รายละเอียดสินค้า'
---
...
> **Skill ต้นฉบับ:** `product-description`
> **License:** MIT
...
ใช้ skill นี้เมื่อต้องการ **เขียน product description** — เหมาะกับ นักเขียน, content creator, นักศึกษาที่ทำ personal brand

## วิธีใช้

บอก Claude ตรงๆ เช่น:

- "ช่วยเขียน product descriptionให้หน่อย"
- "ทำ product-description ให้"
- "product description"
...
```
product description — บริบทคือ [อธิบายสถานการณ์]
```

```
ช่วยเขียน product descriptionสำหรับ [target] — ต้องการแบบ [tone/style]
```
