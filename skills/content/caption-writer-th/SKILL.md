---
name: caption-writer-th
description: caption IG/FB หลาย tone + CTA. Use when user wants to: เขียน caption โพสต์. Triggers on (Thai+EN): 'caption', 'แคปชั่น'
---
...
ใช้ skill นี้เมื่อต้องการ **เขียน caption โพสต์** — เหมาะกับ นักเขียน, content creator, นักศึกษาที่ทำ personal brand

## วิธีใช้

บอก Claude ตรงๆ เช่น:

- "ช่วยเขียน caption โพสต์ให้หน่อย"
- "ทำ caption-writer ให้"
- "caption"
...
```
caption — บริบทคือ [อธิบายสถานการณ์]
```

```
ช่วยเขียน caption โพสต์สำหรับ [target] — ต้องการแบบ [tone/style]
```
