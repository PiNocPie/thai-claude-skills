---
name: slack-message-th
description: announce/update/ask แบบมืออาชีพ. Use when user wants to: เขียน Slack message ในที่ทำงาน. Triggers on (Thai+EN): 'slack message', 'ข้อความ slack'
---

# เขียน Slack message ในที่ทำงาน
...
ใช้ skill นี้เมื่อต้องการ **เขียน slack message ในที่ทำงาน** — เหมาะกับ นักเขียน, content creator, นักศึกษาที่ทำ personal brand

## วิธีใช้

บอก Claude ตรงๆ เช่น:

- "ช่วยเขียน slack message ในที่ทำงานให้หน่อย"
- "ทำ slack-writer ให้"
- "slack message"
...
```
slack message — บริบทคือ [อธิบายสถานการณ์]
```

```
ช่วยเขียน slack message ในที่ทำงานสำหรับ [target] — ต้องการแบบ [tone/style]
```
