---
name: newsletter-writer-th
description: format curate + comment สั้นกระชับ. Use when user wants to: เขียน newsletter รายสัปดาห์. Triggers on (Thai+EN): 'newsletter', 'จดหมายข่าว'
---

# เขียน newsletter รายสัปดาห์
...
ใช้ skill นี้เมื่อต้องการ **เขียน newsletter รายสัปดาห์** — เหมาะกับ นักเขียน, content creator, นักศึกษาที่ทำ personal brand

## วิธีใช้

บอก Claude ตรงๆ เช่น:

- "ช่วยเขียน newsletter รายสัปดาห์ให้หน่อย"
- "ทำ newsletter ให้"
- "newsletter"
...
```
newsletter — บริบทคือ [อธิบายสถานการณ์]
```

```
ช่วยเขียน newsletter รายสัปดาห์สำหรับ [target] — ต้องการแบบ [tone/style]
```
