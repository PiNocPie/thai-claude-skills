...
description: review สัปดาห์ที่ผ่านมา + plan. Use when user wants to: Weekly review. Triggers on (Thai+EN): 'weekly review', 'รีวิวสัปดาห์'
---
...
ใช้ skill นี้เมื่อต้องการ **weekly review** — เหมาะกับ พนักงานออฟฟิศทุกตำแหน่ง, นักศึกษาที่ทำงาน part-time

## วิธีใช้

บอก Claude ตรงๆ เช่น:

- "ช่วยweekly reviewให้หน่อย"
- "ทำ weekly-review ให้"
- "weekly review"
...
```
weekly review — บริบทคือ [อธิบายสถานการณ์]
```

```
ช่วยweekly reviewสำหรับ [target] — ต้องการแบบ [tone/style]
```
