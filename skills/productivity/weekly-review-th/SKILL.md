---
name: weekly-review-th
description: review สัปดาห์ที่ผ่านมา + plan | สำหรับ พนักงานออฟฟิศที่อยากทำงานเร็วข. Triggers when user says (Thai/EN): 'weekly review', 'รีวิวสัปดาห์'
---

# Weekly review

> 🇹🇭 ดัดแปลงเป็นภาษาไทยจาก [VoltAgent/awesome-agent-skills](https://github.com/VoltAgent/awesome-agent-skills/tree/main/skills/weekly-review) · License: MIT

## ทำอะไรได้

review สัปดาห์ที่ผ่านมา + plan
...
```
"ช่วยWeekly review ให้หน่อย บริบทคือ [อธิบายสถานการณ์ของคุณ]"
```

```
"รีวิวสัปดาห์ สำหรับ [กลุ่มเป้าหมาย], อยากได้แบบ [น้ำเสียง/สไตล์]"
```
