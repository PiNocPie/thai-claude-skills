...
description: agenda + pre-read + คำถามชัดๆ. Use when user wants to: เตรียมประชุม. Triggers on (Thai+EN): 'เตรียมประชุม', 'meeting prep'
---
...
ใช้ skill นี้เมื่อต้องการ **เตรียมประชุม** — เหมาะกับ พนักงานออฟฟิศทุกตำแหน่ง, นักศึกษาที่ทำงาน part-time

## วิธีใช้

บอก Claude ตรงๆ เช่น:

- "ช่วยเตรียมประชุมให้หน่อย"
- "ทำ meeting-prep ให้"
- "เตรียมประชุม"
...
```
เตรียมประชุม — บริบทคือ [อธิบายสถานการณ์]
```

```
ช่วยเตรียมประชุมสำหรับ [target] — ต้องการแบบ [tone/style]
```
