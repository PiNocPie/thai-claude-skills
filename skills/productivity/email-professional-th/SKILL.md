...
description: อีเมล professional + ขอ/ปฏิเสธ/follow up. Use when user wants to: เขียนอีเมลทำงาน. Triggers on (Thai+EN): 'เขียนอีเมล', 'email'
---
...
> **Skill ต้นฉบับ:** `professional-email`
> **License:** MIT
...
ใช้ skill นี้เมื่อต้องการ **เขียนอีเมลทำงาน** — เหมาะกับ พนักงานออฟฟิศทุกตำแหน่ง, นักศึกษาที่ทำงาน part-time

## วิธีใช้

บอก Claude ตรงๆ เช่น:

- "ช่วยเขียนอีเมลทำงานให้หน่อย"
- "ทำ professional-email ให้"
- "เขียนอีเมล"
...
```
เขียนอีเมล — บริบทคือ [อธิบายสถานการณ์]
```

```
ช่วยเขียนอีเมลทำงานสำหรับ [target] — ต้องการแบบ [tone/style]
```
