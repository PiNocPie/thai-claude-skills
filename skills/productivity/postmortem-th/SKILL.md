---
name: postmortem-th
description: blameless postmortem หลังเกิดปัญหา. Use when user wants to: เขียน postmortem. Triggers on (Thai+EN): 'postmortem'
---
...
> **Skill ต้นฉบับ:** `07-operations/postmortem`
> **License:** MIT
...
ใช้ skill นี้เมื่อต้องการ **เขียน postmortem** — เหมาะกับ พนักงานออฟฟิศทุกตำแหน่ง, นักศึกษาที่ทำงาน part-time

## วิธีใช้

บอก Claude ตรงๆ เช่น:

- "ช่วยเขียน postmortemให้หน่อย"
- "ทำ 07-operations/postmortem ให้"
- "postmortem"
...
```
postmortem — บริบทคือ [อธิบายสถานการณ์]
```

```
ช่วยเขียน postmortemสำหรับ [target] — ต้องการแบบ [tone/style]
```
