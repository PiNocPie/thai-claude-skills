---
name: okrs-th
description: OKR + key results วัดผลได้. Use when user wants to: เขียน OKRs ทีม. Triggers on (Thai+EN): 'OKR', 'KPI ทีม'
---
...
ใช้ skill นี้เมื่อต้องการ **เขียน okrs ทีม** — เหมาะกับ พนักงานออฟฟิศทุกตำแหน่ง, นักศึกษาที่ทำงาน part-time

## วิธีใช้

บอก Claude ตรงๆ เช่น:

- "ช่วยเขียน okrs ทีมให้หน่อย"
- "ทำ okr-writer ให้"
- "OKR"
...
```
OKR — บริบทคือ [อธิบายสถานการณ์]
```

```
ช่วยเขียน okrs ทีมสำหรับ [target] — ต้องการแบบ [tone/style]
```
