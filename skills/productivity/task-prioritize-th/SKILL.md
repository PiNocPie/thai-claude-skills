...
description: Eisenhower matrix + impact/effort. Use when user wants to: จัดลำดับความสำคัญงาน. Triggers on (Thai+EN): 'prioritize', 'จัดลำดับงาน'
---
...
> **Skill ต้นฉบับ:** `task-prioritization`
> **License:** MIT
...
ใช้ skill นี้เมื่อต้องการ **จัดลำดับความสำคัญงาน** — เหมาะกับ พนักงานออฟฟิศทุกตำแหน่ง, นักศึกษาที่ทำงาน part-time

## วิธีใช้

บอก Claude ตรงๆ เช่น:

- "ช่วยจัดลำดับความสำคัญงานให้หน่อย"
- "ทำ task-prioritization ให้"
- "prioritize"
...
```
prioritize — บริบทคือ [อธิบายสถานการณ์]
```

```
ช่วยจัดลำดับความสำคัญงานสำหรับ [target] — ต้องการแบบ [tone/style]
```
