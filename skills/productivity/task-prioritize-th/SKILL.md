---
name: task-prioritize-th
description: Eisenhower matrix + impact/effort | สำหรับ พนักงานออฟฟิศที่อยากทำงานเร็วข. Triggers when user says (Thai/EN): 'prioritize', 'จัดลำดับงาน'
---

# จัดลำดับความสำคัญงาน

> 🇹🇭 ดัดแปลงเป็นภาษาไทยจาก [VoltAgent/awesome-agent-skills](https://github.com/VoltAgent/awesome-agent-skills/tree/main/skills/task-prioritization) · License: MIT

## ทำอะไรได้

Eisenhower matrix + impact/effort
...
```
"ช่วยจัดลำดับความสำคัญงาน ให้หน่อย บริบทคือ [อธิบายสถานการณ์ของคุณ]"
```

```
"จัดลำดับงาน สำหรับ [กลุ่มเป้าหมาย], อยากได้แบบ [น้ำเสียง/สไตล์]"
```
