---
name: one-on-one-th
description: agenda 1:1 + คำถามที่ควรถาม. Use when user wants to: เตรียม 1-on-1 กับหัวหน้า. Triggers on (Thai+EN): '1on1', 'one on one'
---

# เตรียม 1-on-1 กับหัวหน้า
...
ใช้ skill นี้เมื่อต้องการ **เตรียม 1-on-1 กับหัวหน้า** — เหมาะกับ พนักงานออฟฟิศทุกตำแหน่ง, นักศึกษาที่ทำงาน part-time

## วิธีใช้

บอก Claude ตรงๆ เช่น:

- "ช่วยเตรียม 1-on-1 กับหัวหน้าให้หน่อย"
- "ทำ one-on-one ให้"
- "1on1"
...
```
1on1 — บริบทคือ [อธิบายสถานการณ์]
```

```
ช่วยเตรียม 1-on-1 กับหัวหน้าสำหรับ [target] — ต้องการแบบ [tone/style]
```
