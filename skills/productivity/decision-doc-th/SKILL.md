---
name: decision-doc-th
description: decision document พร้อมเหตุผล + tradeoff. Use when user wants to: เขียน decision doc. Triggers on (Thai+EN): 'decision doc', 'ADR'
---
...
ใช้ skill นี้เมื่อต้องการ **เขียน decision doc** — เหมาะกับ พนักงานออฟฟิศทุกตำแหน่ง, นักศึกษาที่ทำงาน part-time

## วิธีใช้

บอก Claude ตรงๆ เช่น:

- "ช่วยเขียน decision docให้หน่อย"
- "ทำ decision-doc ให้"
- "decision doc"
...
```
decision doc — บริบทคือ [อธิบายสถานการณ์]
```

```
ช่วยเขียน decision docสำหรับ [target] — ต้องการแบบ [tone/style]
```
