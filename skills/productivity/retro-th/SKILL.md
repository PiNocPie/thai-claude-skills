---
name: retro-th
description: retro format Start/Stop/Continue + action. Use when user wants to: จัด retrospective. Triggers on (Thai+EN): 'retrospective', 'retro'
---
...
ใช้ skill นี้เมื่อต้องการ **จัด retrospective** — เหมาะกับ พนักงานออฟฟิศทุกตำแหน่ง, นักศึกษาที่ทำงาน part-time

## วิธีใช้

บอก Claude ตรงๆ เช่น:

- "ช่วยจัด retrospectiveให้หน่อย"
- "ทำ retrospective ให้"
- "retrospective"
...
```
retrospective — บริบทคือ [อธิบายสถานการณ์]
```

```
ช่วยจัด retrospectiveสำหรับ [target] — ต้องการแบบ [tone/style]
```
