---
name: scholarship-essay-th
description: essay ขอทุน + statement of purpose. Use when user wants to: เขียน scholarship essay. Triggers on (Thai+EN): 'scholarship', 'ทุนการศึกษา'
---
...
> **Skill ต้นฉบับ:** `scholarship-essay`
> **License:** MIT
...
ใช้ skill นี้เมื่อต้องการ **เขียน scholarship essay** — เหมาะกับ นักศึกษาปีสูง / เด็กจบใหม่ ที่กำลังหางาน/ฝึกงาน

## วิธีใช้

บอก Claude ตรงๆ เช่น:

- "ช่วยเขียน scholarship essayให้หน่อย"
- "ทำ scholarship-essay ให้"
- "scholarship"
...
```
scholarship — บริบทคือ [อธิบายสถานการณ์]
```

```
ช่วยเขียน scholarship essayสำหรับ [target] — ต้องการแบบ [tone/style]
```
