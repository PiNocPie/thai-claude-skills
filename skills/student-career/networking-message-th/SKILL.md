---
name: networking-message-th
description: cold DM อย่างไรไม่น่ารำคาญ. Use when user wants to: DM networking หา mentor. Triggers on (Thai+EN): 'networking', 'DM mentor'
---

# DM networking หา mentor
...
> **Skill ต้นฉบับ:** `networking-message`
> **License:** MIT
...
ใช้ skill นี้เมื่อต้องการ **dm networking หา mentor** — เหมาะกับ นักศึกษาปีสูง / เด็กจบใหม่ ที่กำลังหางาน/ฝึกงาน

## วิธีใช้

บอก Claude ตรงๆ เช่น:

- "ช่วยdm networking หา mentorให้หน่อย"
- "ทำ networking-message ให้"
- "networking"
...
```
networking — บริบทคือ [อธิบายสถานการณ์]
```

```
ช่วยdm networking หา mentorสำหรับ [target] — ต้องการแบบ [tone/style]
```
