---
name: sop-grad-school-th
description: SOP สำหรับสมัครต่อ ป.โท/เอก. Use when user wants to: Statement of Purpose ป.โท/เอก. Triggers on (Thai+EN): 'statement of purpose', 'SOP grad'
---

# Statement of Purpose ป.โท/เอก
...
> **Skill ต้นฉบับ:** `statement-of-purpose`
> **License:** MIT
...
ใช้ skill นี้เมื่อต้องการ **statement of purpose ป.โท/เอก** — เหมาะกับ นักศึกษาปีสูง / เด็กจบใหม่ ที่กำลังหางาน/ฝึกงาน

## วิธีใช้

บอก Claude ตรงๆ เช่น:

- "ช่วยstatement of purpose ป.โท/เอกให้หน่อย"
- "ทำ statement-of-purpose ให้"
...
```
statement of purpose — บริบทคือ [อธิบายสถานการณ์]
```

```
ช่วยstatement of purpose ป.โท/เอกสำหรับ [target] — ต้องการแบบ [tone/style]
```
