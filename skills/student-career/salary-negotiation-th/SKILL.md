...
description: script + tactic ต่อรอง. Use when user wants to: ต่อรองเงินเดือน. Triggers on (Thai+EN): 'ต่อรองเงินเดือน', 'salary negotiation'
---
...
> **Skill ต้นฉบับ:** `salary-negotiation`
> **License:** MIT
...
ใช้ skill นี้เมื่อต้องการ **ต่อรองเงินเดือน** — เหมาะกับ นักศึกษาปีสูง / เด็กจบใหม่ ที่กำลังหางาน/ฝึกงาน

## วิธีใช้

บอก Claude ตรงๆ เช่น:

- "ช่วยต่อรองเงินเดือนให้หน่อย"
- "ทำ salary-negotiation ให้"
- "ต่อรองเงินเดือน"
...
```
ต่อรองเงินเดือน — บริบทคือ [อธิบายสถานการณ์]
```

```
ช่วยต่อรองเงินเดือนสำหรับ [target] — ต้องการแบบ [tone/style]
```
