---
name: linkedin-profile-th
description: headline + summary + experience. Use when user wants to: ปรับโปรไฟล์ LinkedIn. Triggers on (Thai+EN): 'linkedin profile', 'โปรไฟล์ LinkedIn'
---

# ปรับโปรไฟล์ LinkedIn
...
> **Skill ต้นฉบับ:** `linkedin-profile`
> **License:** MIT
...
ใช้ skill นี้เมื่อต้องการ **ปรับโปรไฟล์ linkedin** — เหมาะกับ นักศึกษาปีสูง / เด็กจบใหม่ ที่กำลังหางาน/ฝึกงาน

## วิธีใช้

บอก Claude ตรงๆ เช่น:

- "ช่วยปรับโปรไฟล์ linkedinให้หน่อย"
- "ทำ linkedin-profile ให้"
- "linkedin profile"
...
```
linkedin profile — บริบทคือ [อธิบายสถานการณ์]
```

```
ช่วยปรับโปรไฟล์ linkedinสำหรับ [target] — ต้องการแบบ [tone/style]
```
