...
description: headline + summary + experience | สำหรับ นักศึกษา. Triggers when user says (Thai/EN): 'linkedin profile', 'โปรไฟล์ LinkedIn'
---

# ปรับโปรไฟล์ LinkedIn

> 🇹🇭 ดัดแปลงเป็นภาษาไทยจาก [VoltAgent/awesome-agent-skills](https://github.com/VoltAgent/awesome-agent-skills/tree/main/skills/linkedin-profile) · License: MIT
...
```
"ช่วยปรับโปรไฟล์ LinkedIn ให้หน่อย บริบทคือ [อธิบายสถานการณ์ของคุณ]"
```

```
"โปรไฟล์ LinkedIn สำหรับ [กลุ่มเป้าหมาย], อยากได้แบบ [น้ำเสียง/สไตล์]"
```
