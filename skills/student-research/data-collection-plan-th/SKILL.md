---
name: data-collection-plan-th
description: survey/interview/experiment design. Use when user wants to: แผนเก็บข้อมูลวิจัย. Triggers on (Thai+EN): 'เก็บข้อมูล', 'data collection'
---
...
ใช้ skill นี้เมื่อต้องการ **แผนเก็บข้อมูลวิจัย** — เหมาะกับ นักศึกษา ป.ตรี/โท/เอก ที่ทำวิจัยหรือ thesis

## วิธีใช้

บอก Claude ตรงๆ เช่น:

- "ช่วยแผนเก็บข้อมูลวิจัยให้หน่อย"
- "ทำ data-collection ให้"
- "เก็บข้อมูล"
...
```
เก็บข้อมูล — บริบทคือ [อธิบายสถานการณ์]
```

```
ช่วยแผนเก็บข้อมูลวิจัยสำหรับ [target] — ต้องการแบบ [tone/style]
```
