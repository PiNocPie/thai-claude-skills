...
description: literature review structured + gap | สำหรับ นักศึกษา. Triggers when user says (Thai/EN): 'literature review', 'ทบทวนวรรณกรรม'
---

# ทำ Literature Review

> 🇹🇭 ดัดแปลงเป็นภาษาไทยจาก [VoltAgent/awesome-agent-skills](https://github.com/VoltAgent/awesome-agent-skills/tree/main/skills/literature-review) · License: MIT

## ทำอะไรได้

literature review structured + gap
...
```
"ช่วยทำ Literature Review ให้หน่อย บริบทคือ [อธิบายสถานการณ์ของคุณ]"
```

```
"ทบทวนวรรณกรรม สำหรับ [กลุ่มเป้าหมาย], อยากได้แบบ [น้ำเสียง/สไตล์]"
```
