---
name: literature-review-th
description: literature review structured + gap. Use when user wants to: ทำ Literature Review. Triggers on (Thai+EN): 'literature review', 'ทบทวนวรรณกรรม'
---
...
> **Skill ต้นฉบับ:** `literature-review`
> **License:** MIT
...
ใช้ skill นี้เมื่อต้องการ **ทำ literature review** — เหมาะกับ นักศึกษา ป.ตรี/โท/เอก ที่ทำวิจัยหรือ thesis

## วิธีใช้

บอก Claude ตรงๆ เช่น:

- "ช่วยทำ literature reviewให้หน่อย"
- "ทำ literature-review ให้"
- "literature review"
...
```
literature review — บริบทคือ [อธิบายสถานการณ์]
```

```
ช่วยทำ literature reviewสำหรับ [target] — ต้องการแบบ [tone/style]
```
