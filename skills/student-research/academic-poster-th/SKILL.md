---
name: academic-poster-th
description: poster conference layout + content. Use when user wants to: ออกแบบ academic poster. Triggers on (Thai+EN): 'academic poster', 'posters วิจัย'
---

# ออกแบบ academic poster
...
ใช้ skill นี้เมื่อต้องการ **ออกแบบ academic poster** — เหมาะกับ นักศึกษา ป.ตรี/โท/เอก ที่ทำวิจัยหรือ thesis

## วิธีใช้

บอก Claude ตรงๆ เช่น:

- "ช่วยออกแบบ academic posterให้หน่อย"
- "ทำ academic-poster ให้"
- "academic poster"
...
```
academic poster — บริบทคือ [อธิบายสถานการณ์]
```

```
ช่วยออกแบบ academic posterสำหรับ [target] — ต้องการแบบ [tone/style]
```
