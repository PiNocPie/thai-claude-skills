...
description: คำถาม + คำตอบที่กรรมการชอบถาม | สำหรับ นักศึกษา. Triggers when user says (Thai/EN): 'thesis defense', 'สอบป้องกัน'
---

# เตรียมสอบ defense thesis

> 🇹🇭 ดัดแปลงเป็นภาษาไทยจาก [VoltAgent/awesome-agent-skills](https://github.com/VoltAgent/awesome-agent-skills/tree/main/skills/thesis-defense) · License: MIT

## ทำอะไรได้

คำถาม + คำตอบที่กรรมการชอบถาม
...
```
"ช่วยเตรียมสอบ defense thesis ให้หน่อย บริบทคือ [อธิบายสถานการณ์ของคุณ]"
```

```
"สอบป้องกัน สำหรับ [กลุ่มเป้าหมาย], อยากได้แบบ [น้ำเสียง/สไตล์]"
```
