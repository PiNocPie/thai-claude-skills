...
description: แปลง reference ทุก format. Use when user wants to: จัด citation APA/MLA/Chicago. Triggers on (Thai+EN): 'citation', 'อ้างอิง', 'APA'
---
...
> **Skill ต้นฉบับ:** `citation-formatter`
> **License:** MIT
...
ใช้ skill นี้เมื่อต้องการ **จัด citation apa/mla/chicago** — เหมาะกับ นักศึกษา ป.ตรี/โท/เอก ที่ทำวิจัยหรือ thesis

## วิธีใช้

บอก Claude ตรงๆ เช่น:

- "ช่วยจัด citation apa/mla/chicagoให้หน่อย"
- "ทำ citation-formatter ให้"
- "citation"
...
```
citation — บริบทคือ [อธิบายสถานการณ์]
```

```
ช่วยจัด citation apa/mla/chicagoสำหรับ [target] — ต้องการแบบ [tone/style]
```
