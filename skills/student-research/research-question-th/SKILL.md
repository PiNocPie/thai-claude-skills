...
description: กำหนด RQ ที่ดี testable + relevant. Use when user wants to: ตั้ง research question. Triggers on (Thai+EN): 'research question', 'คำถามวิจัย'
---
...
> **Skill ต้นฉบับ:** `research-question`
> **License:** MIT
...
ใช้ skill นี้เมื่อต้องการ **ตั้ง research question** — เหมาะกับ นักศึกษา ป.ตรี/โท/เอก ที่ทำวิจัยหรือ thesis

## วิธีใช้

บอก Claude ตรงๆ เช่น:

- "ช่วยตั้ง research questionให้หน่อย"
- "ทำ research-question ให้"
- "research question"
...
```
research question — บริบทคือ [อธิบายสถานการณ์]
```

```
ช่วยตั้ง research questionสำหรับ [target] — ต้องการแบบ [tone/style]
```
