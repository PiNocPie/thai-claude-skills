---
name: icon-spec-th
description: icon system + grid + style. Use when user wants to: กำหนด icon set spec. Triggers on (Thai+EN): 'icon spec', 'ไอคอน'
---
...
ใช้ skill นี้เมื่อต้องการ **กำหนด icon set spec** — เหมาะกับ designer, UX/UI, product designer

## วิธีใช้

บอก Claude ตรงๆ เช่น:

- "ช่วยกำหนด icon set specให้หน่อย"
- "ทำ icon-system ให้"
- "icon spec"
...
```
icon spec — บริบทคือ [อธิบายสถานการณ์]
```

```
ช่วยกำหนด icon set specสำหรับ [target] — ต้องการแบบ [tone/style]
```
