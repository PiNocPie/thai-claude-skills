---
name: wireframe-spec-th
description: wireframe + interaction + edge cases. Use when user wants to: เขียน wireframe specification. Triggers on (Thai+EN): 'wireframe spec'
---

# เขียน wireframe specification
...
ใช้ skill นี้เมื่อต้องการ **เขียน wireframe specification** — เหมาะกับ designer, UX/UI, product designer

## วิธีใช้

บอก Claude ตรงๆ เช่น:

- "ช่วยเขียน wireframe specificationให้หน่อย"
- "ทำ wireframe ให้"
- "wireframe spec"
...
```
wireframe spec — บริบทคือ [อธิบายสถานการณ์]
```

```
ช่วยเขียน wireframe specificationสำหรับ [target] — ต้องการแบบ [tone/style]
```
