---
name: social-graphic-spec-th
description: ขนาด + safe area + template. Use when user wants to: spec ภาพโซเชียลทุก platform. Triggers on (Thai+EN): 'social graphic', 'ภาพโซเชียล'
---

# spec ภาพโซเชียลทุก platform
...
> **Skill ต้นฉบับ:** `social-graphic-spec`
> **License:** MIT
...
ใช้ skill นี้เมื่อต้องการ **spec ภาพโซเชียลทุก platform** — เหมาะกับ designer, UX/UI, product designer

## วิธีใช้

บอก Claude ตรงๆ เช่น:

- "ช่วยspec ภาพโซเชียลทุก platformให้หน่อย"
- "ทำ social-graphic-spec ให้"
- "social graphic"
...
```
social graphic — บริบทคือ [อธิบายสถานการณ์]
```

```
ช่วยspec ภาพโซเชียลทุก platformสำหรับ [target] — ต้องการแบบ [tone/style]
```
