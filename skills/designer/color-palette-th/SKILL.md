...
description: palette + rationale + accessibility. Use when user wants to: สร้าง color palette. Triggers on (Thai+EN): 'color palette', 'จัด color'
---
...
ใช้ skill นี้เมื่อต้องการ **สร้าง color palette** — เหมาะกับ designer, UX/UI, product designer

## วิธีใช้

บอก Claude ตรงๆ เช่น:

- "ช่วยสร้าง color paletteให้หน่อย"
- "ทำ color-palette ให้"
- "color palette"
...
```
color palette — บริบทคือ [อธิบายสถานการณ์]
```

```
ช่วยสร้าง color paletteสำหรับ [target] — ต้องการแบบ [tone/style]
```
