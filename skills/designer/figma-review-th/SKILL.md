...
description: review Figma + post comment อัตโนมัติ. Use when user wants to: review งานดีไซน์ Figma. Triggers on (Thai+EN): 'figma review', 'ตรวจดีไซน์'
---

# review งานดีไซน์ Figma

> 🇹🇭 **ปรับมาเป็นภาษาไทย** | Adapted to Thai
> **ดัดแปลงจาก:** [shomtsm/figma-review-skill](https://github.com/shomtsm/figma-review-skill)
> **Skill ต้นฉบับ:** `figma-review-skill`
> **License:** MIT
...
ใช้ skill นี้เมื่อต้องการ **review งานดีไซน์ figma** — เหมาะกับ designer, UX/UI, product designer

## วิธีใช้

บอก Claude ตรงๆ เช่น:

- "ช่วยreview งานดีไซน์ figmaให้หน่อย"
- "ทำ figma-review-skill ให้"
- "figma review"
...
```
figma review — บริบทคือ [อธิบายสถานการณ์]
```

```
ช่วยreview งานดีไซน์ figmaสำหรับ [target] — ต้องการแบบ [tone/style]
```
...
Skill นี้ดัดแปลงจาก [shomtsm/figma-review-skill](https://github.com/shomtsm/figma-review-skill) ภายใต้ MIT License
