---
name: presentation-design-th
description: slide layout + visual hierarchy. Use when user wants to: ออกแบบสไลด์ presentation. Triggers on (Thai+EN): 'presentation design', 'ดีไซน์สไลด์'
---

# ออกแบบสไลด์ presentation
...
ใช้ skill นี้เมื่อต้องการ **ออกแบบสไลด์ presentation** — เหมาะกับ designer, UX/UI, product designer

## วิธีใช้

บอก Claude ตรงๆ เช่น:

- "ช่วยออกแบบสไลด์ presentationให้หน่อย"
- "ทำ slide-design ให้"
- "presentation design"
...
```
presentation design — บริบทคือ [อธิบายสถานการณ์]
```

```
ช่วยออกแบบสไลด์ presentationสำหรับ [target] — ต้องการแบบ [tone/style]
```
